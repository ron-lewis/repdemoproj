...
The goal of `reprscidemoproj` is to demonstrate a reproducible data analysis project.
...
The `Dockerfile` for this Docker image is also available [here](Dockerfile).
